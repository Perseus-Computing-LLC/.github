...
Zero-dependency persistent memory for AI agents. SQLite + FTS5. AES-256-GCM encrypted. 43 MCP tools. Sub-millisecond recall. Single portable `mimir.db` file.
...
Model Context Threat Scanner. Static analysis for MCP servers. 31 analyzers catching injection, exposed secrets, unverified tool inputs. Run before you trust an MCP server.
